...
bool MultipleVehicleTracker::setStaticState(const double & x, const double & y)
{
  return normal_vehicle_tracker_.setStaticState(x, y) && big_vehicle_tracker_.setStaticState(x, y);
}
