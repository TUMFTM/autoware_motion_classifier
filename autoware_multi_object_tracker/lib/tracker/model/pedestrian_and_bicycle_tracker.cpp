...
bool PedestrianAndBicycleTracker::setStaticState(const double & x, const double & y)
{
  return pedestrian_tracker_.setStaticState(x, y) && bicycle_tracker_.setStaticState(x, y);
}
