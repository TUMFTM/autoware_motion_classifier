...
protected:
  ...
  cuda::unique_ptr<float[]> head_out_offset_uncertainty_d_{nullptr};
  cuda::unique_ptr<float[]> head_out_rot_uncertainty_d_{nullptr};
  cuda::unique_ptr<float[]> head_out_vel_uncertainty_d_{nullptr};
