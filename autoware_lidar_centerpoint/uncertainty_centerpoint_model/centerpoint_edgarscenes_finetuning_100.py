...
data_root = './data/edgar/'
dataset_type = 'EdgarScenesDataset'
db_sampler = dict(
    backend_args=None,
    classes=[
        'car',
    ...
    data_root='./data/edgar/',
    info_path='./data/edgar/edgarscenes_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=5,
...
launcher = 'pytorch'
load_from = 'work_dirs/centerpoint_nuscenes_unc_100/epoch_20.pth'
log_level = 'INFO'
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        in_channels=384,
        loss_bbox=dict(
            loss_weight=0.25, reduction='mean', type='GaussianNLLLoss'),
...
test_dataloader = dict(
    batch_size=4,
    dataset=dict(
        ann_file='edgarscenes_infos_val.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        data_prefix=dict(
        ...
        test_mode=True,
        type='EdgarScenesDataset'),
    drop_last=False,
    num_workers=1,
    persistent_workers=True,
    sampler=dict(shuffle=False, type='DefaultSampler'))
test_evaluator = dict(
    ann_file='./data/edgar/edgarscenes_infos_val.pkl',
    backend_args=None,
    data_root='./data/edgar/',
    metric='bbox',
    type='NuScenesMetric')
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file='edgarscenes_infos_train.pkl',
            backend_args=None,
            box_type_3d='LiDAR',
            data_prefix=dict(
                img='', pts='samples/LIDAR_TOP', sweeps='sweeps/LIDAR_TOP'),
...
work_dir = './work_dirs/centerpoint_unc_edgarscenes_finetuning_100'
